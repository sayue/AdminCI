          ...
          <div class="row">
              <div class="col-lg-12">
                  ...
                  <div class="panel-body">
                    ...
                    <tr>
                      ...
                      <td>
                          ...
                          <a href="<?php echo site_url('cms/project/delete').'/'.$item['id'];?>" class="delete-project">删除</a>
                      </td>
                    </tr>
                    <?php endforeach;?>
                    <?php endif;?>
                ...
                <div class="modal fade" id="myModalAcademic" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                        <form action="<?php echo site_url('cms/project/edit/academic'); ?>" method="post">
                ...
                <div class="modal fade" id="myModalPractical" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                        <form action="<?php echo site_url('cms/project/edit/practical'); ?>" method="post">
