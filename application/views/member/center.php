<div class="content">
	...
	<div class="wrap">
		<p class="breadCrumbNav">
			...
			<a href="<?php echo site_url('member'); ?>">组织架构></a><a href="<?php echo site_url('member/center'); ?>">中心负责人</a>
		</p>
		<div class="introduction">
			<?php if(isset($center)): $id = 0; ?>
			...
			<?php endif;?>
				<a href="<?php echo site_url('member/index/').'/'.$item['id'] ; ?>">
					...
					<span><?php echo $item['name'];?> <?php echo $item['position'];$id++;?><br /><?php if($item['id'] == 1){echo "中心主任";}?></span>
				</a>
		...
		<div class="fenye">
			<form action="">
					...
					<a href="<?php echo site_url('member/center/1');?>">首页</a>
					<a href="<?php if($pagenow == 1){echo site_url('member/center/')."/".$pagenow;}else{echo site_url('member/center/')."/".($pagenow-1);} ?>">上一页</a>
					<a href="<?php if($pagenow == $pages){echo site_url('member/center/')."/".$pagenow;}else{echo site_url('member/center/')."/".($pagenow+1);} ?>">下一页</a>
					<a href="<?php echo site_url('member/center/')."/".$pages;?>">尾页</a>
					<!-- <span>转到：</span>
