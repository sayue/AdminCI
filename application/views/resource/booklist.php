		...
		<div class="fenye">
			<form action="">
				<p>
					...
					<a href="<?php echo site_url('resource/book/1');?>">首页</a>
					<a href="<?php if($pagenow == 1){echo site_url('resource/book/')."/".$pagenow;}else{echo site_url('resource/book/')."/".($pagenow-1);} ?>">上一页</a>
					<a href="<?php if($pagenow == $pages){echo site_url('resource/book/')."/".$pagenow;}else{echo site_url('resource/book/')."/".($pagenow+1);} ?>">下一页</a>
					<a href="<?php echo site_url('resource/book/')."/".$pages;?>">尾页</a>
			</form>
		</div>
	</div>
