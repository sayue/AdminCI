          ...
          <div class="row">
              <div class="col-lg-12">
                  ...
                  <div class="panel-body">
                    ...
                    <tr>
                      ...
                      <td>
                          ...
                          <a href="<?php echo site_url('resource/delete').'/'.$item['id'];?>" class="delete-magazine">删除</a>
                      </td>
                    </tr>
                    <?php endforeach;?>
                    <?php endif;?>
                  ...
                  <div class="panel-body">
                    ...
                    <tr>
                      ...
                      <td>
                          ...
                          <a href="<?php echo site_url('resource/delete').'/'.$item['id'];?>" class="delete-book">删除</a>
                      </td>
                    </tr>
                    <?php endforeach;?>
                    <?php endif;?>
                ...
                <div class="modal fade" id="myModalMagazine" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                        <form action="<?php echo site_url('resource/edit/magazine'); ?>" method="post">
                ...
                <div class="modal fade" id="myModalBook" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                        <form action="<?php echo site_url('resource/edit/book'); ?>" method="post">
