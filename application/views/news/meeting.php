		...
		<div class="fenye">
			<form action="">
				<p>
					...
					<a href="<?php echo site_url('news/meeting/1');?>">首页</a>
					<a href="<?php if($pagenow == 1){echo site_url('news/meeting/')."/".$pagenow;}else{echo site_url('news/meeting/')."/".($pagenow-1);} ?>">上一页</a>
					<a href="<?php if($pagenow == $pages){echo site_url('news/meeting/')."/".$pagenow;}else{echo site_url('news/meeting/')."/".($pagenow+1);} ?>">下一页</a>
					<a href="<?php echo site_url('news/meeting/')."/".$pages;?>">尾页</a>
			</form>
		</div>
	</div>
